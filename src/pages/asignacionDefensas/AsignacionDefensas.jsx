...
export default function AsignacionDefensas() {
  ...
  const cargar = async (texto = '', forzar = false, inicial = false) => {
    try {
      ...
      if (forzar || res.length !== ultimoCount) {
        setDefensas(res || []);
        setUltimoCount(res.length);
      }
  ...
  useEffect(() => {
    cargar(buscar, true, true); // carga inicial
      ...
      {modal && (
        <div className="modal-overlay">
          <div className="modal">
            ...
            <p>
              <b>Estudiante:</b> {actual.estudiante}
            </p>
            <p>
              <b>Tema:</b> {actual.tema}
            </p>
